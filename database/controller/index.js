...
module.exports = async function (api) {
	var threadModel, userModel, dashBoardModel, globalModel, bankModel, sequelize = null;
	switch (databaseType) {
		case "mongodb": {
			const spin = ora({
	...
	const bankData = await require("./bankData.js")(databaseType, bankModel, fakeGraphql);
